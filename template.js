          ...
          <body>
              ...
              <tr>
                <td width="80" style="width:80px; max-width:80px;" >
                  <img width="80" max-width ="80" width="80" height="80px" max-height="80px" src="https://storage.googleapis.com/twiga-email-gen-assets/logo.jpg">
                </td>
                ...
                <td valign:midddle; style="font-family:Sans-serif; font-size:small; line-height:1em;">
                 ...
                 <p style="margin:8px; color:#a29f9f; font-weight:300;"> ${data.mobile} | <a href="https://" style="color:#a29f9f;">www.twigafoods.com</a></p>
                </td>
              </tr>
            </table>
          </body>
